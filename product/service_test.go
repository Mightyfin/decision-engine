...
func TestValidateUsesConfiguredPolicy(t *testing.T) {
	s := Service{Store: testStore{Policy{ID: "prd", TenantID: "ten", Currency: "ZMW", PricingPolicyID: "pp_1", Version: 2, Active: true, MinimumAmount: 100, MaximumAmount: 1000, MinimumTermDays: 7, MaximumTermDays: 30, RepaymentIntervalDays: 30, GraceDays: 3, AllocationOrder: []string{"penalty", "fees", "interest", "principal"}}}}
