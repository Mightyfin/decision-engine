...
type testPricing struct{ quote pricing.Quote }

func (p testPricing) Quote(context.Context, pricing.QuoteRequest) (pricing.Quote, error) {
	return p.quote, nil
}
...
func TestSubmitRequiresWorkloadRoleAndUsesMinorUnits(t *testing.T) {
	...
	policy := product.Policy{ID: "product_1", TenantID: "tenant_1", Currency: "ZMW", PricingPolicyID: "pp_1", Version: 1, Active: true, MinimumAmount: 100, MaximumAmount: 10_000, MinimumTermDays: 7, MaximumTermDays: 90, RepaymentIntervalDays: 30, GraceDays: 3, AllocationOrder: []string{"penalty", "fees", "interest", "principal"}}
