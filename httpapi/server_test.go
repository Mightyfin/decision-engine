...
func TestSubmitRequiresWorkloadRoleAndUsesMinorUnits(t *testing.T) {
	...
	server := Server{Auth: testAuth{Principal{Subject: "workload", TenantID: "tenant_1", Environment: "sandbox", ApplicationID: "client_1", Roles: map[string]bool{"decision_workload": true, "credit_application_writer": true}}}, Credit: service, Applications: store, Pricing: testPricing{}}
	...
	req.Header.Set("Idempotency-Key", "test-submit-key-1234")
