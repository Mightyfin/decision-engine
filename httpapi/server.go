...
func (s Server) Handler() http.Handler {
	...
	m.HandleFunc("GET /v1/internal/tenants/{tenant_id}/credit/applications/{id}/purchase-restriction", s.purchaseRestriction)
	m.HandleFunc("POST /v1/internal/tenants/{tenant_id}/credit/applications/{id}/purchase-restriction", s.purchaseRestriction)
...
func (s Server) createPricingPolicy(w http.ResponseWriter, r *http.Request) {
	...
	var in struct {
		...
		BorrowerCharges   []pricing.BorrowerChargePolicy `json:"borrower_charges"`
	}
